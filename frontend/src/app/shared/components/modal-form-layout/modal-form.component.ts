...
import {AfterViewInit, Component, ComponentRef, Inject, inject, OnInit, Type, ViewChild, ViewContainerRef} from '@angular/core';
...
export class ModalFormComponent implements AfterViewInit{
  ...
  ngAfterViewInit(): void {
    if (this.data.formComponent!=null) {
      // this.formContainer.clear();
      this.formComponentRef = this.formContainer.createComponent(this.data.formComponent);

      if (this.data.formData) {
        Object.assign(this.formComponentRef.instance, this.data.formData);
      }
    }
  }
